...
static struct spi_board_info a10_spi_printer_device[] __initdata = 
{
	{
		.modalias = "spidev",
...
{
	spi_register_board_info(a10_spi_printer_device,ARRAY_SIZE(a10_spi_printer_device));
}
...
static void __init socfpga_init(void)
{
	...
	spi_device_init();
	printk(KERN_ALERT"fun: socfpga_init() done\n");//new
}
